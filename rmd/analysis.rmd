...
### Intersection Table
* issue: the line counts as an intersection
  * Where is the dividing line in that line?
```{r intersection_table, include=TRUE, echo = FALSE, warning = FALSE, message = FALSE}
intersection_tibble %>%
  kable(format = "html", 
        caption = "Count of Intersections Between City of Chicago Police Districts and Zipcodes") %>%
